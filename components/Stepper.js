...
export function Stepper(props) {
    ...
    const minValue = props.minValue === null || props.minValue === undefined ? defaultMinValue
        : parseFloat (props.minValue);
    const maxValue =  props.maxValue === null || props.maxValue === undefined ? defaultMaxValue
        : parseFloat (props.maxValue);
    const increment = props.increment === null || props.increment === undefined ? defaultIncrement
        : parseFloat (props.increment);
